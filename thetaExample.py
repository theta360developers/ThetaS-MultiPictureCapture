...
def main():
	...
	try:
		...
		print('\nIt looks like you are not using Python 3 \nI need to adjust the input statement.\n\nPlease enter your selection again.\n ')
		res = raw_input("Select image capture resolution"
													" - H for 2688x5376 or return for 1024x2048\n")
		print('res = '+(res))
	setOptions(res)
	try:
		...
		print('\nNo input captured - assuming 1 image.\n')
		picToTake = 1
	startTime = time.time()
	if(picToTake == 0):
